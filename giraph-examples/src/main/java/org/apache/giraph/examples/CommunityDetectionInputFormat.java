 ...
 * <code>string</code> vertex community tag value and a list of
 * <code>long</code> vertices' IDs specified in JSON format.
 */
public class CommunityDetectionInputFormat extends
    TextVertexInputFormat<LongWritable, Text, FloatWritable> {

  @Override
  public TextVertexReader createVertexReader(
          InputSplit split, TaskAttemptContext context) throws IOException {
    return new JsonLongTextLongVertexReader();
  }
   ...
   * [4,C,[[3,2.1],[2,2.1]]]
   */
  class JsonLongTextLongVertexReader extends
    ...
    @Override
    protected Text getValue(JSONArray jsonVertex) throws JSONException,
    IOException {

...
public class ComputeCallable<I extends WritableComparable, V extends Writable,
  ...
  private final Counter partitionNumberCounter;
  ...
  public ComputeCallable(
    ...
    partitionNumberCounter = metrics.getCounter(MetricNames.PARTITION_NUMBER);
  }
  ...
  private PartitionStats computePartition(
    ...
    synchronized (partition) {
      for (Vertex<I, V, E> vertex : partition) {
        ...
        partitionStats.setVertexMaxCount(partitionStats.getVertexCount());
        partitionStats.setVertexMinCount(partitionStats.getVertexCount());
        partitionStats.addEdgeCount(vertex.getNumEdges());
        partitionStats.setEdgeMaxCount(partitionStats.getEdgeCount());
        partitionStats.setEdgeMinCount(partitionStats.getEdgeCount());
      }
